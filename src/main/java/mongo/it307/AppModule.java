...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("mongo-it307 -3609398888378164095 12eab17d-44d5-4495-87ce-ff53b4136326 mongo-it307".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in mongo.it307 package as a set of config entries
        return configLoader.fromResource("mongo/it307/settings");
    }
